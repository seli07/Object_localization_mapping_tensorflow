...
def draw_bounding_box_on_image(image,
  ...
  Args:
    ...
    use_normalized_coordinates: If True (default), treat coordinates
      ymin, xmin, ymax, xmax as relative to the image.  Otherwise treat
      coordinates as absolute.
	  SKE (04/04/2019) added the functionality to append display strings and thier cX and cY to enable dobot pickup of specific object
	  i can us the list ll in main program to start a seperate function to execute with dobot.
  """
  ...
  ll=[]
  #lm=[]
  lal1 = str(display_str_list).split(' ', 1)[0]
  lal = str(re.findall(r'\w+(?=:)', lal1))
  ll.append(lal)
  ll.append(cX)
  ll.append(cY)
  #print(type(ll))
  ...
  #return draw_bounding_box_on_image(cX,cY)
